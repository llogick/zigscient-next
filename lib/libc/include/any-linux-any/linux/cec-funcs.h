...
/* Only for CEC 2.0 and up */
static __inline__ void cec_msg_request_lip_support(struct cec_msg *msg,
...
static __inline__ void cec_ops_request_lip_support(const struct cec_msg *msg,
					       __u16 *phys_addr)
{
	*phys_addr = (msg->msg[2] << 8) | msg->msg[3];
}

static __inline__ void cec_msg_report_lip_support(struct cec_msg *msg, __u32 sqid)
{
	msg->len = 6;
...
static __inline__ void cec_ops_report_lip_support(const struct cec_msg *msg,
					      __u32 *sqid)
{
...
static __inline__ void cec_msg_request_audio_and_video_latency(struct cec_msg *msg,
...
static __inline__ void cec_ops_request_audio_and_video_latency(const struct cec_msg *msg,
					       __u8 *video_format,
					       __u8 *hdr_format,
					       __u8 *vrr_format,
					       __u8 *audio_format,
...
static __inline__ void cec_msg_report_audio_and_video_latency(struct cec_msg *msg,
							  __u16 video_latency,
							  __u16 audio_latency)
{
	msg->len = 6;
...
static __inline__ void cec_ops_report_audio_and_video_latency(const struct cec_msg *msg,
					      __u16 *video_latency,
					      __u16 *audio_latency)
{
...
static __inline__ void cec_msg_request_audio_latency(struct cec_msg *msg,
						 int reply,
						 __u8 audio_format,
						 __u8 audio_format_extension)
{
...
static __inline__ void cec_ops_request_audio_latency(const struct cec_msg *msg,
						 __u8 *audio_format,
						 __u8 *audio_format_extension)
{
...
static __inline__ void cec_msg_report_audio_latency(struct cec_msg *msg,
						__u16 audio_latency)
{
	msg->len = 4;
...
static __inline__ void cec_ops_report_audio_latency(const struct cec_msg *msg,
						__u16 *audio_latency)
{
	*audio_latency = (msg->msg[2] << 8) | msg->msg[3];
}

static __inline__ void cec_msg_request_video_latency(struct cec_msg *msg,
						 int reply, __u8 video_format,
						 __u8 hdr_format,
						 __u8 vrr_format)
{
...
static __inline__ void cec_ops_request_video_latency(const struct cec_msg *msg,
						 __u8 *video_format,
						 __u8 *hdr_format,
						 __u8 *vrr_format)
{
...
static __inline__ void cec_msg_report_video_latency(struct cec_msg *msg,
						__u16 video_latency)
{
	msg->len = 4;
...
static __inline__ void cec_ops_report_video_latency(const struct cec_msg *msg,
						__u16 *video_latency)
{
	*video_latency = (msg->msg[2] << 8) | msg->msg[3];
}

static __inline__ void cec_msg_update_sqid(struct cec_msg *msg, __u32 sqid)
{
	msg->len = 6;
...
static __inline__ void cec_ops_update_sqid(const struct cec_msg *msg,
				       __u32 *sqid)
{
	*sqid = (msg->msg[2] << 24) | (msg->msg[3] << 16) |
		(msg->msg[4] << 8) | msg->msg[5];
